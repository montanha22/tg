...
# seasonal_time_series documentation build
...
from seasonal_time_series import __version__ as release

# -- Project information -----------------------------------------------------

project = "seasonal_time_series"
author = "Kedro"
...
htmlhelp_basename = "seasonal_time_seriesdoc"
...
latex_documents = [
    (
        master_doc,
        "seasonal_time_series.tex",
        "seasonal_time_series Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "seasonal_time_series",
        "Project seasonal_time_series codebase.",
        "Data-Science",
    )
]
